namespace Terrasoft.Configuration
{
	...
	#region Class: UpdateEntitySchemaOperationRightsVwSysDcmLibScript

	public class UpdateEntitySchemaOperationRightsVwSysDcmLibScript : IInstallScriptExecutor
	{

		#region Fields: Private

		private static readonly Guid _vwSysDcmLibSchemaUId = new Guid("ab972a77-ca14-4dd4-9d90-eaaae8b1197a");
		...
		private static readonly Guid _recordInDcmDesignerForAllEmployees =
			new Guid("22daf27a-6c38-4afd-b183-0556fb7985b6");
		private static readonly Guid _recordInSSPForAllExternals =
			new Guid("cd354eac-0f5b-42e1-9150-aa2db0276614");
		...
		private static void RemoveOperationRightPositionGaps(UserConnection userConnection) {
			...
			operationRightEntity.SetColumnValue("SubjectSchemaUId", _vwSysDcmLibSchemaUId);
		...
		public void Execute(UserConnection userConnection) {
			OverrideAllOperationRightRecordsWithOne(userConnection, _allEmployeesRoleId,
				_recordInDcmDesignerForAllEmployees);
