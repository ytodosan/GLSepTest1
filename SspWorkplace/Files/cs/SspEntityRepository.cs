namespace Terrasoft.Configuration.SspEntity
{
	...
	public class SspEntityRepository : ISspEntityRepository {
		...
		public void SetEntityAdministratedByOperations(Guid entityUId) {
			...
			_securityEngine.SetEntitySchemaOperationsRightLevel(UsersConsts.AllEmployersSysAdminUnitUId, entityUId, SchemaOperationRightLevels.All);
			_securityEngine.SetEntitySchemaOperationsRightLevel(UsersConsts.PortalUsersSysAdminUnitUId, entityUId,
				SchemaOperationRightLevels.CanRead | SchemaOperationRightLevels.CanEdit | SchemaOperationRightLevels.CanAppend);
			_securityEngine.SetEntitySchemaAdministratedByOperations(entityUId, true);
