namespace Terrasoft.Configuration.PageEntity
{
	...
	public class PageEntityManager : IPageEntityManager
	{
		...
		/// <inheritdoc cref="IPageEntityManager.GetPage"/>
		public PageEntity GetPage(Guid cardSchemaUId) {
			var pages = _pageEntityRepository.GetAll();
			return pages.FirstOrDefault(p => p.CardSchemaUId.Equals(cardSchemaUId));
		}
