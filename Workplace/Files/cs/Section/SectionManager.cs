namespace Terrasoft.Configuration.Section
{
	...
	public class SectionManager : ISectionManager
	{
		...
		private List<AllowedWorkplaceStructureInfo> _allowedWorkplaceStructureInfo;
		private List<AllowedWorkplaceStructureInfo> AllowedWorkplaceStructureInfo
		{
			get
			{
				if(_allowedWorkplaceStructureInfo != null)
				{
					return _allowedWorkplaceStructureInfo;
				}
				_allowedWorkplaceStructureInfo =
		...
		private List<Guid> GetAllowedWorkplaceSectionsIds(Guid workplaceId) {
			return AllowedWorkplaceStructureInfo.Find(info => info.Workplace.Id == workplaceId)?.AllowedSections?
